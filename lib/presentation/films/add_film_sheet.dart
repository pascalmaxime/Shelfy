...
class _AddFilmSheetState extends ConsumerState<AddFilmSheet> {
  ...
  String? _imageUrl; // conservée depuis l'API
  String? _genre;
  ...
  void initState() {
    ...
    // (évite un crash DropdownButtonFormField si la valeur est inconnue)
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (v) {
                ...
                if (year == null || year < 1888 || year > 2100) return 'Invalide';
                return null;
              },
            ),
            const SizedBox(height: 12),
